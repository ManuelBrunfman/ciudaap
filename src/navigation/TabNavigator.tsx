...
// Tama√±o optimizado para los iconos
const ICON_SIZE = 50; // Aumentado pero controlado
const IONICON_SIZE = 38; // Tama√±o proporcionalmente ajustado para los Ionicons

// Permite ajustar estilos por Ìcono sin tocar el layout global (imageOverrides/containerOverrides).
const renderIcon = (
...
const createScreenOptions = (t: AppTheme, routeName: string) => ({
  ...
  tabBarIcon: ({ focused, color, size }: { focused: boolean; color: string; size: number }) => {
    ...
    if (routeName === 'Contact') {
      // Ajust· marginLeft si querÈs mover el Ìcono de Contacto horizontalmente.
